            ...
            <div class="el-row" style="margin-left: -12px; margin-right: -12px;">
                ...
                <div class="el-col el-col-12" style="padding-left: 12px; padding-right: 12px">
                    <div class="ff_card h-100">
                        <h3 class="mb-3"><?php esc_html_e('Get Started with Tiny Forms WordPress Plugin', 'fluentform') ?></h3>
                        <p class="text"><?php esc_html_e('Getting started with the Tiny Forms is easier than you could imagine. All our customers are not developers and we want to make your life easier.', 'fluentform') ?></p>
                            ...
                            <div id="ff_dialog_wrapper" class="el-dialog__wrapper hidden">
                                <div role="dialog" aria-modal="true" class="el-dialog" style="margin-top: 25vh; width: 50%;">
                                    <div class="el-dialog__header mb-5">
                                        <h4><?php esc_html_e( 'Tiny Forms Video Tutorials', 'fluentform' ) ?></h4>
                ...
                <div class="el-col el-col-12" style="padding-left: 12px; padding-right: 12px">
                    <div class="ff_card h-100">
                        ...
                        <p class="text">
                            <?php esc_html_e('Please check the following articles for getting started with Tiny Forms', 'fluentform') ?>
                        </p>
                        <ul class="ff_list">
                    ...
                    <div class="ff_card h-100">
                        <div class="ff_media_group items-start">
                            ...
                            <div class="ff_media_body ml-4">
                                ...
                                <p class="text mb-4">
                                    <?php esc_html_e('If you need any feature on Tiny Forms, then please request a feature to us with your requirement.', 'fluentform') ?>
                                </p>
