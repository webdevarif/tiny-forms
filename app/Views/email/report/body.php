                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    <td class="content-block"
                                        ...
                                        $generateText = sprintf(
                                            ...
                                            __('This email has been generated from Tiny Forms at %1$s%2$s%3$s.', 'fluentform'),
                                            '<a href="' .  site_url() . '">',
                                            get_bloginfo('name'),
                                            '</a>'
                                        );
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="aligncenter content-block"
                                ...
                                $footerText = sprintf(
                                    ...
                                    __('This email has been sent from %1$syour website%2$s via Tiny Forms. You can disable this email %3$syour website%4$s', 'fluentform'),
                                    '<a href="' .  site_url() . '">',
                                    '</a>',
