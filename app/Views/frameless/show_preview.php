            ...
            ?>
                <div class="ff_styler_promo">
                    ...
                    <div class="ff_promo_body">
                        <p><a target="_blank" href="https://wpmanageninja.com/docs/fluent-form/fluent-forms-styles/"><?php esc_html_e('Advanced Form styler', 'fluentform'); ?></a> <?php esc_html_e('is available in Pro version of Tiny Forms. You can style every element of the forms including input fields, form container, success / error messages and many more.', 'fluentform'); ?></p>
                        ...
                        <h5><?php esc_html_e('Integrations available in Tiny Forms Pro', 'fluentform'); ?></h5>
                        <ul class="ff_addons">
                            <?php
...
<div class="ff_notice">
    <div class="ff_notice_inner">
        ...
        <p><?php esc_html_e('You are seeing preview version of Tiny Forms. This form is only accessible for Admin users. Other users may not access this page. To use this for in a page please use the following shortcode: ', 'fluentform') ?>
