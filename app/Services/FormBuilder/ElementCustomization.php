...
if (! defined('FLUENTFORMPRO')) {
    $fluentformDateConfigSettings['inline_help_text'] = 'Available on Tiny Forms Pro';
}
...
$fluentformElementCustomizationSettings = [
    ...
    'calculation_settings' => [
        ...
        'text'          => '<strong>Calculation Field Settings</strong><br/>Calculate the value based on other numeric field is available on pro version of Tiny Forms. Please install Tiny Forms Pro to use this feature <br /> <a target="_blank" rel="noopener" href="https://fluentforms.com/pricing/?utm_source=plugin&amp;utm_medium=wp_install&amp;utm_campaign=ff_upgrade&amp;theme_style=twentytwentythree">
        Upgrade to Pro                </a>',
