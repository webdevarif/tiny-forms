...
class MailChimpIntegration extends IntegrationManagerController
{
    ...
    public function __construct(Application $application)
    {
        ...
        $this->description = __('Tiny Forms Mailchimp module allows you to create Mailchimp newsletter signup forms in WordPress', 'fluentform');
        ...
        return [
            'fields' => [
                ...
                [
                    ...
                    'tips'               => __('Associate your Mailchimp merge tags to the appropriate Tiny Forms fields by selecting the appropriate form field from the list. Also, Mailchimp Date fields supports only MM/DD/YYYY and DD/MM/YYYY format.', 'fluentform'),
