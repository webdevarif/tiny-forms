...
class Menu
{
    ...
    public function register()
    {
        ...
        if (defined('FLUENTFORMPRO')) {
            $title = __('Tiny Forms Pro', 'fluentform');
        } else {
            $title = __('Tiny Forms', 'fluentform');
        }
    ...
    public function renderFormSettings($form_id)
    {
        wp_localize_script('fluentform_form_settings', 'FluentFormApp', [
            ...
            'integrationsResource' => [
                ...
                'instruction' => __("Tiny Forms Pro has tons of integrations to take your forms to the next level. From payment gateways to quiz building, SMS notifications to email marketing - you'll get integrations for various purposes. Even if you don't find your favorite tools, you can integrate them easily with Zapier.", 'fluentform'),
            ],
