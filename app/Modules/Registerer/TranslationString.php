...
class TranslationString
{
    public static function getAdminI18n()
    {
        $i18n = array(
            ...
            'Design Customization is only available on Pro Version of Tiny Forms.' => __('Design Customization is only available on Pro Version of Tiny Forms.', 'fluentform'),
            ...
            'Welcome to WP Tiny Forms' => __('Welcome to WP Tiny Forms', 'fluentform'),
            'Thank you for installing WP Tiny Forms - The Most Advanced Form Builder Plugin for WordPress.' => __('Thank you for installing WP Tiny Forms - The Most Advanced Form Builder Plugin for WordPress.', 'fluentform'),
            'Check the Video Intro' => __('Check the Video Intro', 'fluentform'),
            ...
            'Tiny Forms AI-Assisted' => __('Tiny Forms AI-Assisted', 'fluentform'),
            ...
            'You are using the free version of Tiny Forms.' => __('You are using the free version of Tiny Forms.', 'fluentform'),
    ...
    public static function getSettingsI18n()
    {
        $i18n = array(
            ...
            'This feature is only available in pro version of Tiny Forms' => __('This feature is only available in pro version of Tiny Forms', 'fluentform'),
            ...
            /* translators: 1: opening link tag, 2: closing link tag */
            'The %1$sSlack webhook URL%2$s where Tiny Forms will send JSON payload.' => __('The %1$sSlack webhook URL%2$s where Tiny Forms will send JSON payload.', 'fluentform'),
            ...
            'For better email deliverability, we recommend to use FluentSMTP Plugin(completely free & Opensource). FluentSMTP connects with your Email Service Provider natively and makes sure your emails including form notifications are being delivered 💯. Built by Tiny Forms Devs for you.' => __('For better email deliverability, we recommend to use FluentSMTP Plugin(completely free & Opensource). FluentSMTP connects with your Email Service Provider natively and makes sure your emails including form notifications are being delivered 💯. Built by Tiny Forms Devs for you.', 'fluentform'),
            ...
            'This field only available on pro version.Please install Tiny Forms Pro.' => __('This field only available on pro version.Please install Tiny Forms Pro.', 'fluentform'),
            'No Template found. Please make sure you are using latest version of Tiny Forms' => __('No Template found. Please make sure you are using latest version of Tiny Forms', 'fluentform'),
            'Update ' => __('Update ', 'fluentform'),
            'Create ' => __('Create ', 'fluentform'),
            ...
            'If you enable this then Tiny Forms will verify the form submission with Akismet. It will save you from spam form submission.' => __('If you enable this then Tiny Forms will verify the form submission with Akismet. It will save you from spam form submission.', 'fluentform'),
            ...
            'Looks like you do not have latest version of Tiny Forms Pro Installed. Please install latest version of Tiny Forms Pro to use this feature' => __('Looks like you do not have latest version of Tiny Forms Pro Installed. Please install latest version of Tiny Forms Pro to use this feature', 'fluentform'),
    ...
    public static function getGlobalSettingsI18n()
    {
        $i18n = array(
            ...
            'Administrators have full access to Tiny Forms. Add other managers giving specific permissions.' => __('Administrators have full access to Tiny Forms. Add other managers giving specific permissions.', 'fluentform'),
            ...
            'Administrators have full access to Tiny Forms. By selecting additional roles below, you can give access to other user roles.' => __('Administrators have full access to Tiny Forms. By selecting additional roles below, you can give access to other user roles.', 'fluentform'),
            ...
            'Please update Tiny Forms Pro Addon to latest version' => __('Please update Tiny Forms Pro Addon to latest version ', 'fluentform'),
            'Verify Connection Again' => __('Verify Connection Again', 'fluentform'),
            'hCaptcha Settings' => __('hCaptcha Settings', 'fluentform'),
            'Tiny Forms integrates with hCaptcha, a free service that protects your website from spam and abuse.Please note, these settings are required only if you decide to use the hCaptcha field.' => __('Tiny Forms integrates with hCaptcha, a free service that protects your website from spam and abuse.Please note, these settings are required only if you decide to use the hCaptcha field.', 'fluentform'),
            ...
            'Tiny Forms integrates with reCAPTCHA, a free service that protects your website from spam and abuse. Please note, these settings are required only if you decide to use the reCAPTCHA field.' => __('Tiny Forms integrates with reCAPTCHA, a free service that protects your website from spam and abuse. Please note, these settings are required only if you decide to use the reCAPTCHA field.', 'fluentform'),
            ...
            'As you are using Tiny Forms Lite, you do not require a license to use it. Enjoy!' => __('As you are using Tiny Forms Lite, you do not require a license to use it. Enjoy!', 'fluentform'),
            /* translators: 1: opening link tag, 2: closing link tag */
            ...
            'Thank you for purchasing Tiny Forms Pro Add On! Please enter your license key below.' => __('Thank you for purchasing Tiny Forms Pro Add On! Please enter your license key below.', 'fluentform'),
            ...
            'Tiny Forms Pro' => __('Tiny Forms Pro', 'fluentform'),
            'Your license is active! Enjoy Tiny Forms Pro' => __('Your license is active! Enjoy Tiny Forms Pro', 'fluentform'),
            ...
            'Tiny Forms integrates with Cloudflare Turnstile, a free service that protects your website from spam and abuse. Please note, these settings are required only if you decide to use the Turnstile field.' => __('Tiny Forms integrates with Cloudflare Turnstile, a free service that protects your website from spam and abuse. Please note, these settings are required only if you decide to use the Turnstile field.', 'fluentform'),
            ...
            'Tiny Forms offers seamless integration with CleanTalk, a powerful anti-spam service designed to protect your website from spam submissions and bot attacks. To enable this feature, you\'ll need to configure the CleanTalk settings within Tiny Forms then it will work for all forms.' => __('Tiny Forms offers seamless integration with CleanTalk, a powerful anti-spam service designed to protect your website from spam submissions and bot attacks. To enable this feature, you\'ll need to configure the CleanTalk settings within Tiny Forms then it will work for all forms.', 'fluentform'),
    ...
    public static function getEditorI18n()
    {
        $i18n = array(
            ...
            'Get Tiny Forms Pro' => __('Get Tiny Forms Pro', 'fluentform'),
            ...
            'Accept Payment online as part of the Forms submission process. With Tiny Forms Powerful payment integration, you can easily accept and process payments in your Tiny Forms via Stripe/PayPal. Payment Module is available on Pro Version.' => __('Accept Payment online as part of the Forms submission process. With Tiny Forms Powerful payment integration, you can easily accept and process payments in your Tiny Forms via Stripe/PayPal. Payment Module is available on Pro Version.', 'fluentform'),
            'This field is only available on Tiny Forms Pro add-on' => __('This field is only available on Tiny Forms Pro add-on', 'fluentform'),
            ...
            'No Active Payment Method Found.Please configure from Tiny Forms Settings' => __('No Active Payment Method Found. Please configure from Tiny Forms Settings', 'fluentform'),
            'Layout Type' => __('Layout Type', 'fluentform'),
    ...
    public static function getEntriesI18n()
    {
        $i18n = array(
            ...
            'This feature is available on pro version of Tiny Forms.' => __('This feature is available on pro version of Tiny Forms.', 'fluentform'),
            ...
            'Migrate other plugins forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.' => __('Migrate other plugins forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.', 'fluentform'),
            'Migration tools only works if you have any other contact form plugin already installed along with Tiny Forms.' => __('Migration tools only works if you have any other contact form plugin already installed along with Tiny Forms.', 'fluentform'),
            'Learn More' => __('Learn More', 'fluentform'),
            'Integration' => __('Integration', 'fluentform'),
            'Title' => __('Title', 'fluentform'),
            'Conditional' => __('Conditional', 'fluentform'),
            ...
            'Please upgrade to Tiny Forms PDF to unlock this feature.' => __('Please upgrade to Tiny Forms PDF to unlock this feature.', 'fluentform'),
            'This is a Tiny Forms PDF Feature' => __('This is a Tiny Forms PDF Feature', 'fluentform'),
    ...
    {
        $i18n = array(
            'Tiny Forms Modules' => __('Tiny Forms Modules', 'fluentform'),
            'Here is the list of all Tiny Forms modules. You can enable or disable the modules based on your need.' => __('Here is the list of all Tiny Forms modules. You can enable or disable the modules based on your need.', 'fluentform'),
            'all' => __('all', 'fluentform'),
    ...
    public static function getTransferModuleI18n()
    {
        $i18n = array(
            ...
            'Select the forms you would like to export. When you click the download button below, Tiny Forms will create a JSON file for you to save to your computer.Once you\'ve saved the downloaded file, you can use the Import tool to import the forms.' => __('Select the forms you would like to export. When you click the download button below, Tiny Forms will create a JSON file for you to save to your computer.Once you\'ve saved the downloaded file, you can use the Import tool to import the forms.',  'fluentform'),
            ...
            'Select the Tiny Forms export file(.json) you would like to import. When you click the import button below, Tiny Forms will import the forms.' => __('Select the Tiny Forms export file(.json) you would like to import. When you click the import button below, Tiny Forms will import the forms.', 'fluentform'),
            'Select File' => __('Select File', 'fluentform'),
            'Click the Choose File button to upload a' => __('Click the Choose File button to upload a', 'fluentform'),
            'Tiny Forms export file from your computer.' => __('Tiny Forms export file from your computer.', 'fluentform'),
            'Import' => __('Import', 'fluentform'),
            'Edit Form' => __('Edit Form', 'fluentform'),
            'Tiny Forms Migrator' => __('Tiny Forms Migrator', 'fluentform'),
            'Migrate other plugins\' forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.' => __('Migrate other plugins\' forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.', 'fluentform'),
            ...
            'Click the Choose File button to upload a Tiny Forms export file from your computer' => __('Click the Choose File button to upload a Tiny Forms export file from your computer', 'fluentform'),
            'Migrate other plugins forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.' => __('Migrate other plugins forms into Tiny Forms with ease. Please note that previously imported forms and entries will be reset and updated again.', 'fluentform'),
            'Migration tools only works if you have any other contact form plugin already installed along with Tiny Forms.' => __('Migration tools only works if you have any other contact form plugin already installed along with Tiny Forms.', 'fluentform'),
    ...
    public static function getPaymentsI18n()
    {
        $i18n = array(
            ...
            'Tiny Forms Payment Module' => __('Tiny Forms Payment Module', 'fluentform'),
            'Enable your users to pay online as part of the Forms submission process.With Tiny Forms Powerful payment integration, you can easily accept and process payments in your Tiny Forms. Just activate this module and setup your payment methods.' => __('Enable your users to pay online as part of the Forms submission process. With Tiny Forms Powerful payment integration, you can easily accept and process payments in your Tiny Forms.Just activate this module and setup your payment methods.', 'fluentform'),
            'Enable Tiny Forms Payment Module' => __('Enable Tiny Forms Payment Module', 'fluentform'),
            ...
            'Tiny Forms Coupon Module' => __('Tiny Forms Coupon Module', 'fluentform'),
            'Enable your users to apply coupon / discount code while purchasing something using Tiny Forms Payment Module. Just activate this module and setup your coupons.' => __('Enable your users to apply coupon / discount code while purchasing something using Tiny Forms Payment Module.Just activate this module and setup your your coupons.', 'fluentform'),
            'Enable Tiny Forms Coupon Module' => __('Enable Tiny Forms Coupon Module', 'fluentform'),
