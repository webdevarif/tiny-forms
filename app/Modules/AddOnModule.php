    ...
    public function getPremiumAddOns()
    {
        ...
        return [
            ...
            'webhook' => [
                ...
                'description'  => __('Broadcast your Tiny Forms Submission to any web api endpoint with the powerful webhook module.', 'fluentform'),
            ...
            'zapier' => [
                ...
                'description'  => __('Connect your Tiny Forms data with Zapier and push data to thousands of online softwares.', 'fluentform'),
            ...
            'trello' => [
                ...
                'description'  => __('Tiny Forms Trello Module allows you to create Trello card from submiting forms.', 'fluentform'),
            ...
            'google_sheet' => [
                ...
                'description'  => __('Add Tiny Forms Submission to Google sheets when a form is submitted.', 'fluentform'),
            ...
            'activecampaign' => [
                ...
                'description'  => __('Tiny Forms ActiveCampaign Module allows you to create ActiveCampaign list signup forms in WordPress, so you can grow your email list.', 'fluentform'),
            ...
            'campaign_monitor' => [
                ...
                'description'  => __('Tiny Forms Campaign Monitor module allows you to create Campaign Monitor newsletter signup forms in WordPress, so you can grow your email list.', 'fluentform'),
            ...
            'constatantcontact' => [
                ...
                'description'  => __('Connect Constant Contact with Tiny Forms and create subscriptions forms right into WordPress and grow your list.', 'fluentform'),
            ...
            'convertkit' => [
                ...
                'description'  => __('Connect ConvertKit with Tiny Forms and create subscription forms right into WordPress and grow your list.', 'fluentform'),
            ...
            'getresponse' => [
                ...
                'description'  => __('Tiny Forms GetResponse module allows you to create GetResponse newsletter signup forms in WordPress, so you can grow your email list.', 'fluentform'),
            ...
            'hubspot' => [
                ...
                'description'  => __('Connect HubSpot with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'icontact' => [
                ...
                'description'  => __('Connect iContact with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'platformly' => [
                ...
                'description'  => __('Connect Platform.ly with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'moosend' => [
                ...
                'description'  => __('Connect MooSend with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'sendfox' => [
                ...
                'description'  => __('Connect SendFox with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'mailerlite' => [
                ...
                'description'  => __('Connect your Tiny Forms with MailerLite and add subscribers easily.', 'fluentform'),
            ...
            'sendinblue' => [
                ...
                'description'  => __('Tiny Forms Brevo (formerly SendInBlue) Module allows you to create contacts on your list, so you can grow your email list.', 'fluentform'),
            ...
            'drip' => [
                ...
                'description'  => __('Tiny Forms Drip Module allows you to create contacts on your Drip list, so you can grow your email list.', 'fluentform'),
            ...
            'cleverreach' => [
                ...
                'description'  => __('CleverReach is web-based email marketing software for managing email campaigns and contacts. Use Tiny Forms to grow your CleverReach subscriber list', 'fluentform'),
            ...
            'automizy' => [
                ...
                'description'  => __('Connect Automizy with Tiny Forms and subscribe a contact when a form is submitted.', 'fluentform'),
            ...
            'notion' => [
                ...
                'description'  => __('Capture Tiny Forms Submission to your Notion workspaces — and do it exactly the way you want.', 'fluentform'),
