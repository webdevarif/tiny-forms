...
class TrackModule
{
    ...
    public function getInitialNotice()
    {
        return [
            ...
            'title'   => __('Want to make Tiny Forms better with just one click?', 'fluentform'),
            'message' => 'We will collect a few server data if you permit us. It will help us troubleshoot any inconveniences you may face while using FluentForm, and guide us to add better features according to your usage. NO FORM SUBMISSION DATA WILL BE COLLECTED.<br/><input checked type="checkbox" id="ff-optin-send-email"> You can also send me Tiny Forms tips and tricks occasionally',
            'links'   => [
                [
                    'href'     => admin_url('admin.php?page=fluent_forms'),
                    'btn_text' => 'Yes, I want to make Tiny Forms Better',
